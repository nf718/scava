 ...
 ******************************************************************************/
package org.eclipse.scava.factoid.forums.emotion;
...
public class ForumsEmotionFactoid extends AbstractFactoidMetricProvider{

	protected List<IMetricProvider> uses;
	
	@Override
	public String getShortIdentifier() {
		return "ForumsEmotion";
	}

	@Override
	public String getFriendlyName() {
		return "Forums Emotion";
		// This method will NOT be removed in a later version.
	}

	@Override
	public String getSummaryInformation() {
		return "This metod generates the factoids rgarding emotions for forums"; // This method will NOT be removed in a later version.
	}
...
//		factoid.setCategory(FactoidCategory.BUGS);
		...
		ForumsEmotionsTransMetric emotionsTransMetric = ((EmotionsTransMetricProvider)uses.get(0)).adapt(context.getProjectDB(project));
		...
		float positiveEmotionPercentageSum = 0,
			...
			stringBuffer.append(" % of posts express positive emotions, while ");
			...
			stringBuffer.append(" % of posts raised a suprise emotion. ");
			stringBuffer.append("A post can express positive, negative and surprise emotions at the same time.\n");
